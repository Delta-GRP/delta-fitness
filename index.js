...
optionTwo.style.backgroundImage = 'url("assets/bicep-curls-with-dumbbells-picture-id494725174.jpg")'
...
optionFive.style.backgroundImage = 'url("assets/photo_2022-05-05_14-17-02.jpg")'
...
for(let i = 0; i < 6; i++){
    for(let j = 0; j < 5; j++){
        ...
        if(i == 0 && j > 2){
            image.style.backgroundImage = 'url("assets/red-x-transparent-png-14.png")'
        }else if(i == 0 && j <= 2){
            image.style.backgroundImage = 'url("assets/red-tick-check-mark-icon-symbol-sign-png-31623349268odaqglzvyi.png")'
        }else if(i == 1 && j > 3){
            image.style.backgroundImage = 'url("assets/red-x-transparent-png-14.png")'
        }else if(i == 1 && j <= 3){
            image.style.backgroundImage = 'url("assets/red-tick-check-mark-icon-symbol-sign-png-31623349268odaqglzvyi.png")'
